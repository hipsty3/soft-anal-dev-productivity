...
# Load data
df = pd.read_csv("processed/3_analysis_ready_data_100_dev.csv")
...
plt.tight_layout()
plt.savefig("plots_100_dev/productivity_by_ai_group_boxplots.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("plots_100_dev/ai_group_counts.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("plots_100_dev/ai_group_proportions.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("plots_100_dev/top10_languages_by_developers.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("plots_100_dev/top10_languages_mean_ai_usage.png", dpi=300, bbox_inches="tight")
plt.show()
