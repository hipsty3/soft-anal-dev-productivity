...
plt.tight_layout()
plt.savefig("plots_new/productivity_by_ai_group_boxplots.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("plots_new/ai_group_counts.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("plots_new/ai_group_proportions.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("plots_new/top10_languages_by_developers.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("plots_new/top10_languages_mean_ai_usage.png", dpi=300, bbox_inches="tight")
plt.show()